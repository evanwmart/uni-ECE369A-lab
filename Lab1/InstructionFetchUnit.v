...
module InstructionFetchUnit(Instruction, PCResult, Reset, Clk);
    ...
    PCAdder _PCAdder(PCResult, PCAddResult);
    
    ProgramCounter _ProgramCounter(PCAddResult, PCResult, Reset, Clk);
    
    InstructionMemory _InstructionMemory(PCResult, Instruction);
